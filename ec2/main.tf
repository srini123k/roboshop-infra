...
resource "null_resource" "provisioner" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      "ansible-pull -i localhost, -U https://github.com/srini123k/roboshop-ansible.git roboshop.yml -e role_name=${var.component} -e env=${var.env}"
    ]
  }
    ...
    "Statement": [
      {
        ...
        "Resource": "arn:aws:ssm:us-east-1:922057391995:parameter/${var.env}.${var.component}*"
      },
      {
        "Sid": "VisualEditor1",
        "Effect": "Allow",
