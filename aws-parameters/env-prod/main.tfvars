parameters = [
  { name = "prod.frontend.catalogue_url", value = "http://catalogue-prod.devopsb71.cloud:80/", type = "String" },
  { name = "prod.frontend.user_url", value = "http://user-prod.devopsb71.cloud:80/", type = "String" },
  { name = "prod.frontend.cart_url", value = "http://cart-prod.devopsb71.cloud:80/", type = "String" },
  { name = "prod.frontend.shipping_url", value = "http://shipping-prod.devopsb71.cloud:80/", type = "String" },
  { name = "prod.frontend.payment_url", value = "http://payment-prod.devopsb71.cloud:80/", type = "String" },
  ...
  { name = "prod.payment.user_host", value = "user-prod.devopsb71.cloud", type = "String" },
  { name = "prod.payment.user_port", value = "80", type = "String" },
  { name = "prod.payment.amqp_host", value = "rabbitmq-prod.devopsb71.cloud", type = "String" },
  { name = "prod.catalogue.mongo", value = "true", type = "String" },
  { name = "prod.catalogue.mongo_url", value = "mongodb://mongodb-prod.devopsb71.cloud:27017/users", type = "String" },
